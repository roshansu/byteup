export default function MemberCard({name, photo,phone, github, login, linkedin, specialization, course, passout}) {
    return (
        <div className="flex m-2 flex-wrap items-center justify-center gap-8">
            <div className="bg-white rounded-2xl pb-2 overflow-hidden border border-gray-300">
                ...
                <div className="flex flex-col items-center">
                    <p className="font-medium text-lg mt-3">{name}</p>
                    ...
                    <p className={` ${login?'block:':'hidden'} text-sm text-black font-medium mb-4`}>&#128222; {phone}</p><div className="flex space-x-4 mb-4 text-xl text-indigo-600">
